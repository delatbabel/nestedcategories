...
/**
 * Class CategoriesTableRegionsArraySeeder
 *
 ...
 */
class CategoriesTableRegionsSeeder extends CategoriesTableBaseListSeeder
{
    /**
     * Return a list.
     *
    ...
    protected function getNodes()
    {
         ...
         */
        $load_file = __DIR__ . '/examples/all-regions.txt';
